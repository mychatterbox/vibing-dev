...
차근차근 확인합니다.  
1. PE 를 설치할 드라이브를 몇 GB 정도 볼륨축소해서 PE 설치할 파티션을 하나 만듭니다.  
...
sources 폴더에 boot.wim 파일이 있는지 확인하고,  
파일명이 다르거나, 다른 원하는 PE(wim)가 있을 경우 boot.wim 이름으로 변경합니다.  
4. BOOTICE - UEFI 부팅 항목 편집에서 PE 항목을 추가하고 편집합니다.  
